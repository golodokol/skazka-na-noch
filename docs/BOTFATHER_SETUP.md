...
```text
Персональная сонная сказка за 30 секунд — для уставших родителей.
Вы читаете сами, бот снимает нагрузку «что придумать».
5 бесплатных сказок в неделю. Не заменяем маму и папу — помогаем с ритуалом перед сном.
```
...
| `FREE_STORIES_PER_WEEK` | `5` | [MONETIZATION.md](MONETIZATION.md) |
